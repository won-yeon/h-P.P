        ...
        <div class="container">
            ...
            <div class="mypage_point">
                ...
                <div class="roomimgslide">
                    <div class="delux_img1">
                        <div><img src="${pageContext.request.contextPath }/resources/img/executive/bedroom-1822410_1920.jpg"  height="370" > </div>
                        <div><img src="${pageContext.request.contextPath }/resources/img/executive/executive.jpg" height="370">   </div>
                        <div><img src="${pageContext.request.contextPath }/resources/img/executive/couch-1835923_1920.jpg" height="370">     </div>
                        <div><img src="${pageContext.request.contextPath }/resources/img/executive/living-room-581073_1920.jpg" height="370"></div>
                    </div>
                    <div class="delux_img2">
                        <div class="delux_img2_1"><img src="${pageContext.request.contextPath }/resources/img/executive/bedroom-1822410_1920.jpg"" height="94" ></div>
                        <div class="delux_img2_1"><img src="${pageContext.request.contextPath }/resources/img/executive/executive.jpg" height="94"></div>
                        <div class="delux_img2_1"><img src="${pageContext.request.contextPath }/resources/img/executive/couch-1835923_1920.jpg" height="94"></div>
                        <div class="delux_img2_1"><img src="${pageContext.request.contextPath }/resources/img/executive/living-room-581073_1920.jpg" height="94"></div>
                    </div>
                </div>
