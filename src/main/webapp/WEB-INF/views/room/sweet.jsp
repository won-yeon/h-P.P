        ...
        <div class="container">
            ...
            <div class="mypage_point">
                ...
                <div class="roomimgslide">
                    <div class="sweet_img1">
                        <div><img src="${pageContext.request.contextPath }/resources/img/sweet/sweet.jpg"  height="370" > </div>
                        <div><img src="${pageContext.request.contextPath }/resources/img/sweet/dining-room-332207_1920.jpg" height="370">   </div>
                        <div><img src="${pageContext.request.contextPath }/resources/img/sweet/hotel-389256_1280.jpg" height="370">     </div>
                        <div><img src="${pageContext.request.contextPath }/resources/img/sweet/villa-cortine-palace-949547_1920.jpg" height="370"></div>
                    </div>
                    <div class="sweet_img2">
                        <div class="delux_img2_1"><img src="${pageContext.request.contextPath }/resources/img/sweet/sweet.jpg" height="94" ></div>
                        <div class="delux_img2_1"><img src="${pageContext.request.contextPath }/resources/img/sweet/dining-room-332207_1920.jpg" height="94"></div>
                        <div class="delux_img2_1"><img src="${pageContext.request.contextPath }/resources/img/sweet/hotel-389256_1280.jpg" height="94"></div>
                        <div class="delux_img2_1"><img src="${pageContext.request.contextPath }/resources/img/sweet/villa-cortine-palace-949547_1920.jpg" height="94"></div>
                    </div>
                </div>
